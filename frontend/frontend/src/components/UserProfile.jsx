...
export default function UserProfile({ data }) {
  ...
  const stats = [
    rank != null && { label: "Rank", value: `#${rank}` },
    score != null && { label: "Score", value: score },
    level != null && { label: "Level", value: level },
    nbGems != null && { label: "Gems", value: nbGems },
    nbPoints != null && { label: "Points", value: nbPoints },
    nbTokens != null && { label: "Tokens", value: nbTokens },
    tokensToClaim != null && tokensToClaim > 0 && { label: "To Claim", value: tokensToClaim },
  ].filter(Boolean);
